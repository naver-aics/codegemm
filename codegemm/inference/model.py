...
transformer_configs = {
    ...
    "meta-llama/Llama-3.1-70B-Instruct": dict(model_name="Meta-Llama-3-70B-Instruct", block_size=8192, n_layer=80, n_head=64, n_local_heads=8, dim=8192, intermediate_size=28672, vocab_size=128256, rope_base=500000),
...
class Attention(nn.Module):
    def __init__(self, config: ModelArgs, linear_class=nn.Linear, linear_kwargs=None, fuse_linears=True) -> None:
        ...
        if fuse_linears:
            ...
            if DEBUG_INIT and linear_class == CodeGEMMLinear:
