# copied from: https://github.com/Vahe1994/AQLM/blob/main/src/finetune.py
...
from codegemm.quantization.aq_engine import replace_parameter_
from codegemm.quantization.utils import iterate_minibatches
