# copied from: https://github.com/Vahe1994/AQLM/blob/main/convert_legacy_model_format.py
...
from codegemm.quantization.aq import QuantizedLinear, QuantizedWeight
from codegemm.quantization.modelutils import get_model, save_quantized_model
from codegemm.quantization.utils import is_signed


def load_quantized_model_with_old_pickle(base_model_name: str, cache_dir: str, quantized_model_name: str, **kwargs):
    ...
    quantized_model = get_model(base_model_name, cache_dir, None, **kwargs)
    quantized_model_src = get_model(base_model_name, cache_dir, quantized_model_name, **kwargs)
...
def load_quantized_model_from_fdsp_checkpoint(base_model_name: str, cache_dir: str, fsdp_checkpoint_path: str, **kwargs):
    original_model = get_model(base_model_name, cache_dir, None, **kwargs)
