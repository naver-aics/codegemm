# copied from: https://github.com/Vahe1994/AQLM/blob/main/src/utils.py
...
def _dequantize_weight(
    ...
    if scales is not None:
        ...
        n = num_in_groups // scales.shape[1]
        scale_reshaped = scales.repeat_interleave(n, dim=1).view(num_out_groups, num_in_groups, 1, 1)
        reconstructed_weight_groupwise = reconstructed_weight_groupwise.mul(scale_reshaped)
